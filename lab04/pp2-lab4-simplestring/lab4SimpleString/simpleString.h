...
public:
    ...
    SimpleString(const SimpleString& text);
    SimpleString(SimpleString&& simpleStringToBeMoved);
    ~SimpleString();
    ...
    bool equal_to(const SimpleString& secondSimpleString, bool case_sensitive=true) const;
    void append(const SimpleString& secondSimpleString);
    SimpleString substr(std::size_t pos=0, std::size_t count=-1) const;
    int compare(const SimpleString& secondSimpleString, bool case_sensitive=true) const;
};
