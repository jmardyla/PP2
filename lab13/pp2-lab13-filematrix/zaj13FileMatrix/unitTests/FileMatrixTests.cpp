...
std::string fileInWritablePath(string_view fileName)
{
    ...
    if (bobotVariable)
    {
        ...
        return (std::filesystem::path(writableDirectory) / fileName).string();
    }
...
{
    constexpr IndexType ROWS = 5, COLS = 7;
...
{
    constexpr IndexType ROWS = 6, COLS = 5;
...
{
    constexpr IndexType ROWS = 10, COLS = 6;
...
{
    constexpr IndexType ROWS = 5, COLS = 4;
